...
You can start writing assets in `dagster_wine_example/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `dagster_wine_example_tests` directory and you can run tests using `pytest`:

```bash
pytest dagster_wine_example_tests
```
